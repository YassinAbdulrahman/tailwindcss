        ...
        <div className="mt-[30px] flex justify-between flex-wrap flex-col md:flex-row gap-[30px]">
          <div className="flex items-start gap-[15px] w-[340px] max-w-full">
            ...
            <p className="font-normal text-sm tracking-[0.8px]">
              ...
              laudantium quis facilis eligendi? Illo quae repellendus numquam
              harum, recusandae maxime repellat, facere unde, cupiditate sint
              ipsa. Saepe voluptatibus quia ut?
            </p>
          </div>
          <div>
            {contact.map((item) => (
            ...
            {links.map((link) => (
              <li key={link}>
                <a
                  ...
                  className="hover:text-primary transition-color duration-200 text-base"
                >
                  {link}
                </a>
              </li>
